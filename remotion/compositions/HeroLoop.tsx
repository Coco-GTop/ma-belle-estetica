...
export const HERO_PHOTOS = [
  "hero/frames/f-mask.jpg", // maschera viso (1032x1500)
  "hero/frames/f-nails.jpg", // unghie (696x1500)
  "hero/frames/f-massage.jpg", // massaggio viso (1125x1500)
  "hero/frames/f-product.jpg", // prodotti professionali (1125x1500)
];
